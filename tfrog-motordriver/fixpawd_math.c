...
inline fixp4 fp4sin( fixp4 x )
{
	...
	if( x > FP4_PI_2 ) y = fp4cos( x - FP4_PI_2 );
	else if( x > FP4_PI_4 ) y = 2*fp4mulf( fp4cosf( x/2 ), fp4sinf( x/2 ) );
	else y = fp4sinf(x);
...
inline fixp4 fp4cos( fixp4 x )
{
	...
	if( x > FP4_PI_2 ) res = -fp4sin( x - FP4_PI_2 );
	else if( x > FP4_PI_4 ){
		res = fp4sinf( x/2 );
...
inline fixp4 fp4sqrtinv( fixp4 x )
{
	...
	if(      x & 0x40000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 30 ];
	else if( x & 0x20000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 29 ];
	else if( x & 0x10000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 28 ];
	else if( x & 0x08000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 27 ];
	else if( x & 0x04000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 26 ];
	else if( x & 0x02000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 25 ];
	else if( x & 0x01000000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 24 ];
	else if( x & 0x00800000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 23 ];
	else if( x & 0x00400000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 22 ];
	else if( x & 0x00200000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 21 ];
	else if( x & 0x00100000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 20 ];
	else if( x & 0x00080000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 19 ];
	else if( x & 0x00040000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 18 ];
	else if( x & 0x00020000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 17 ];
	else if( x & 0x00010000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 16 ];
	else if( x & 0x00008000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 15 ];
	else if( x & 0x00004000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 14 ];
	else if( x & 0x00002000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 13 ];
	else if( x & 0x00001000 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 12 ];
	else if( x & 0x00000800 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 11 ];
	else if( x & 0x00000400 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 10 ];
	else if( x & 0x00000200 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 9 ];
	else if( x & 0x00000100 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 8 ];
	else if( x & 0x00000080 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 7 ];
	else if( x & 0x00000040 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 6 ];
	else if( x & 0x00000020 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 5 ];
	else if( x & 0x00000010 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 4 ];
	else if( x & 0x00000008 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 3 ];
	else if( x & 0x00000004 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 2 ];
	else if( x & 0x00000002 ) res = fp4_sqrt[ 32 - FP4_POINTBIT + 1 ];
	else if( x & 0x00000001 ) res = fp4_sqrt[ 32 - FP4_POINTBIT ];
	else return 0;
	/*
	// 'if' lines mean:
	for( i = 30; i >= 0; i -- ){
		if( x & ( 1 << i ) ){
			res = fp4_sqrt[ 32 - FP4_POINTBIT + i ];
			break;
		}
	}
	*/
...
inline fixp4 fp4exp( fixp4 x )
{
	...
	for( i = 31-FP4_POINTBIT; i < 33; i ++ ){
		if( x & mask ) res = fp4mulf( res, fp4_exp[i] );
		mask <<= 1;
	}
	res >>= ( 32 - FP4_POINTBIT - 6 );

	if( x & ( 1 << ( 33 - 31 + FP4_POINTBIT + 0 ) ) ) res = fp4mul( res, fp4_exp[33] );
	if( x & ( 1 << ( 33 - 31 + FP4_POINTBIT + 1 ) ) ) res = fp4mul( res, fp4_exp[34] );
	if( x & ( 1 << ( 33 - 31 + FP4_POINTBIT + 2 ) ) ) res = fp4mul( res, fp4_exp[35] );
	
	/*
	// 'if' lines mean:
	for( i = 33; i < 36; i ++ ){
		if( x & mask ) res = fp4mul( res, fp4_exp[i] );
		mask <<= 1;
	}
	*/
	
	if( inv ) return fp4div( FP4_ONE, res );
	return res;
}
